...
function jogar1(){
    ...
    if (inputNome.value){    
        ...
        numeroSecreto.value = Math.floor((Math.random() * 100) + 1);     
        ...
        numeroJogador.setAttribute("placeholder", "Insira aqui o suposto número")
...
function jogar2(){
    ...
    if (inputNome.value){    
        ...
        numeroSecreto.id="numeroSecreto"
        numeroSecreto.setAttribute("type", "password")
        numeroSecreto.setAttribute("placeholder", "Informe o Número secreto")
        jogo.appendChild(numeroSecreto)
...
function rodar(){
    if(numeroSecreto.value && numeroJogador.value){    
        ...
        if (game){
            ...
            if(numeroJogador.value > 99){
                alert("Numero acima do limite (99)")
            }
            else{            
